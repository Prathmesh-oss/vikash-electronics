...
export const metadata: Metadata = {
  ...
  description: `${BUSINESS_DATA.name} specializes in professional repair and servicing for Speakers, Power Amplifiers, Sharpy Moving Head Lights, DJ Lights, Mixers, Home Theatres, and TVs in Limbayat, Surat, Gujarat. Call: ${BUSINESS_DATA.formattedPhone}`,
  keywords: [
    ...
    "Sound Mixer Repairing Limbayat",
    "Home Theatre Repairing Surat",
    "Vikash Electronics Limbayat Surat",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "Plot No. 199, Sarve No. 1-2, Sanjay Nagar, Udhna Yard, Limbayat",
